    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='NGN', max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
                ('part_number', models.CharField(max_length=50)),
                ('vehicle_type', models.CharField(blank=True, choices=[('car', 'Car'), ('motorcycle', 'Motorcycle'), ('truck', 'Truck'), ('suv', 'SUV'), ('van', 'Van')], max_length=20)),
